...
python $FAIRSEQ_PATH/fairseq_cli/hydra_train.py \
  ...
  task.data=/disk/scratch1/ramons/data/zerospeech/tsv/pt/french/ task.label_dir=/disk/scratch1/ramons/data/zerospeech/tsv/pt/french/l12_recovered/500 task.labels='["km"]' model.label_rate=50 
